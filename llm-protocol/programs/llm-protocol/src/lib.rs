...
pub mod llm_protocol {
    ...
    pub fn claim_reward(ctx: Context<ClaimReward>) -> Result<()> {
        ...
        let vault_bump = global_state.reward_vault_bump;
        let seeds = &[b"reward_vault".as_ref(), &[vault_bump]];
        let signer = &[&seeds[..]];
...
/// Actualiza el estado matemático global de recompensas
...
/// Calcula y guarda cuánto ha generado este usuario
